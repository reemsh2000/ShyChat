...
export const SignUpForm: React.FC = () => {
	...
	return (
		<form onSubmit={handleSubmit} className="md:w-1/3 w-full ">
			<Input name="email" label="Email" value={account.email} onChange={handleChange} type="text" labelStyle="labelStyle" inputStyle="inputStyle" error={errors.email} errorStyle="errorMessage" />
			<Input name="userName" label="Name" styleName="mt-4" value={account.userName} onChange={handleChange} type="text" labelStyle="labelStyle" inputStyle="inputStyle" error={errors.userName} errorStyle="errorMessage" />

			<Input name="password" label="Password" value={account.password} onChange={handleChange} type="password" styleName="mt-4" labelStyle="labelStyle" inputStyle="inputStyle" error={errors.password} errorStyle="errorMessage" />
			<Input name="confirmPassword" label="Confirm Password" value={account.confirmPassword} onChange={handleChange} type="password" styleName="mt-4" labelStyle="labelStyle" inputStyle="inputStyle" error={errors.confirmPassword} errorStyle="errorMessage" placeholder="Re-enter Password" />
